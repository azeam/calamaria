...
class Species {
  ...
  factory Species.fromJSON(Map<String, dynamic> json, [Map<String, dynamic> likelihoodJson]) {
    var species = new Species(
      ...
      mental: new SpeciesDataMental(isTouching: json['Mental']['Touching'] as bool, isNotTouching: json['Mental']['NotTouching']),
      preocular: new SpeciesDataPreocular(isPresent: json['Preocular']['Present'] as bool, isAbsent: json['Preocular']['IsAbsent'] as bool),
      supraocular: new SpeciesDataSupraocular(isPresent: json['Preocular']['Present'] as bool, isAbsent: json['Preocular']['IsAbsent'] as bool),
